	...
	<div class="col-md-12">
		<table class="table table-stiped table-bordered">
			...
			<tbody>
				...
				<tr style="vertical-align: inherit;">
					<td class="col-md-2">
						...
						<a href="<?= $item_page ?>"><img src="<?= base_url(); ?>small_pics/<?= $row->small_pic ?>"></a>
						<?php
						} else {
			...
			<tr>
				...
				<td colspan="3" style="text-align: right;font-weight: bold;">Shipping Fee: <?php $grand_total = $grand_total+$shipping;?></td>
