...
<p style="margin-top: 30px;">
	<a href="<?= $create_account_url ?>"><button type="button" class="btn btn-primary">Customer Accounts</button></a>
</p>
<div class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header" data-original-title>
			<h2><i class="halflings-icon white tag"></i><span class="break"></span>Manage Customer Accounts</h2>
			<div class="box-icon">
				...
				<tbody>
					...
					<tr>
						...
						<td class="center">
							...
							<!-- <a class="btn btn-danger" href="<?= $edit_account_url ?>"">
