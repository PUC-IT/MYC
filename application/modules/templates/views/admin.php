...
<html lang="en">
	<head>
		...
		<link id="base-style-responsive" href="<?php echo base_url();?>admin/css/style-responsive.css" rel="stylesheet">
		<link href='http://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800&subset=latin,cyrillic-ext,latin-ext' rel='stylesheet' type='text/css'>
		<!-- end: CSS -->
		
		<!-- The HTML5 shim, for IE6-8 support of HTML5 elements -->
		<!--[if lt IE 9]>
		<script src="<?php echo base_url();?>admin/http://html5shim.googlecode.com/svn/trunk/html5.js"></script>
						...
						<ul class="nav pull-right">
							...
							<li class="dropdown hidden-phone">
								...
								<ul class="dropdown-menu messages">
									...
									<li>
										<a href="#">
											<span class="avatar"><img src="<?php echo base_url();?>admin/img/avatar.jpg" alt="Avatar"></span>
											<span class="header">
												<span class="from">
													Dennis Ji
												</span>
		...
		<div class="container-fluid-full">
			<div class="row-fluid">
				...
				<div id="content" class="span10">
					...
					<!-- start: JavaScript-->
					<script src="<?php echo base_url();?>admin/js/jquery-1.9.1.min.js"></script>
					<script src="<?php echo base_url();?>admin/js/jquery-migrate-1.0.0.min.js"></script>
					
					<script src="<?php echo base_url();?>admin/js/jquery-ui-1.10.0.custom.min.js"></script>
					
					<script src="<?php echo base_url();?>admin/js/jquery.ui.touch-punch.js"></script>
					...
					<script src="<?php echo base_url();?>admin/js/jquery.gritter.min.js"></script>
					
					<script src="<?php echo base_url();?>admin/js/jquery.imagesloaded.js"></script>
					
					<script src="<?php echo base_url();?>admin/js/jquery.masonry.min.js"></script>
					
					<script src="<?php echo base_url();?>admin/js/jquery.knob.modified.js"></script>
					
					<script src="<?php echo base_url();?>admin/js/jquery.sparkline.min.js"></script>
					
					<script src="<?php echo base_url();?>admin/js/counter.js"></script>
					
					<script src="<?php echo base_url();?>admin/js/retina.js"></script>
