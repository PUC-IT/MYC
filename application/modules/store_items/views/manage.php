...
<div class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header" data-original-title>
			<h2><i class="halflings-icon white tag"></i><span class="break"></span>Items Management</h2>
			<div class="box-icon">
			...
			<table class="table table-striped table-bordered bootstrap-datatable datatable">
				...
				<tbody>
					...
					{ 
						...
						$del_item_url = base_url()."store_items/deleteconf/".$row->id;
						$status = $row->status;
					...
					<tr>
						...
						<td class="center">
							<a class="btn btn-success" href="<?= $view_item_url ?>" target="blank;">
								<i class="halflings-icon white zoom-in"></i>
							</a> 
							<a class="btn btn-info" href="<?= $edit_item_url ?>">
								<i class="halflings-icon white edit"></i>
							</a>
							<a class="btn btn-danger" href="<?= $del_item_url ?>"">
